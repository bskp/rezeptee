...
export const matchHeading = (depth) => (node) => node.type === 'heading' && node.depth === depth
export const matchZone = (identifier) => (node) => node.type === 'zone' && node.identifier === identifier
